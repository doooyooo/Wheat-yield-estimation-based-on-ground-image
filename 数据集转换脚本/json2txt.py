...
"""
#本脚本用于将JSON文件生成对应的txt文件，需要输入图片文件夹位置，json文件夹位置，即将存放的txt文件夹位置
...
if __name__ == "__main__":
	# 图像文件夹
    image_dir = r"E:\dataset\spike\images"
    # labelme 的标注结果
    json_dir = r"E:\dataset\spike\labels"
    # yolo 使用的 txt 结果
    save_dir = r"E:\dataset\spike\txt"
